## 一行代码就能解决的算法题(学习链接：https://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247492201&idx=2&sn=d6406674823d39c090b32756e380768b&scene=21#wechat_redirect)

下文是 labuladong 在 LeetCode 刷题过程中总结的三道有趣的「脑筋急转弯」题目，可以使用算法编程解决，但只要稍加思考，就能找到规律，直接想出答案。
